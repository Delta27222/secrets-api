...
@router.post("/projects/{project_id}/addMembers", status_code=HTTPStatus.CREATED)
async def create_many_project_member_route(
    project_id: str,
    project_member: AddManyProjectMembers,
    ...
    users = []
    for id in project_member.users:
        users.append(ProjectMemberCreate(
            project=project_member.project,
            role=project_member.role,
            user=id
        ))

    await create_many_project_members(db, project_id, users)
    return {"success": True}
